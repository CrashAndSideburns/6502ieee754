...
class TestBasicAddition(unittest.TestCase):
    ...
    def test_min_subnorm_addition(self):
    ...
    def test_subnorm_addition(self):
    ...
    def test_max_subnorm_addition(self):
    ...
    def test_min_norm_addition(self):
    ...
    def test_max_norm_addition(self):
